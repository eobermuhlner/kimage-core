...
class AstroProcessIntegrationTest : AbstractAstroProcessIntegrationTest() {
    ...
    fun `processAstro runs with enhance using arcsinh`() {
        ...
        val config = ProcessConfig(
            ...
            enhance = EnhanceConfig(
                steps = mutableListOf(
                    EnhanceStepConfig(arcsinh = AsinhConfig(beta = 5.0))
                )
            ),
            output = OutputFormatConfig(
                outputName = "test_output",
    ...
    @Test
    fun `processAstro runs with enhance using removeStars`() {
        initTestRun()
        createRandomAstroImages(testDir, "light", 10, addBiasNoise = false)
        ...
        val config = ProcessConfig(
            ...
            enhance = EnhanceConfig(
                steps = mutableListOf(
                    EnhanceStepConfig(removeStars = RemoveStarsConfig())
                )
            ),
            output = OutputFormatConfig(
                outputName = "test_output",
    ...
    fun `processAstro runs with enhance using tgvDenoise`() {
        ...
        val config = ProcessConfig(
            ...
            enhance = EnhanceConfig(
                steps = mutableListOf(
                    EnhanceStepConfig(tgvDenoise = TGVDenoiseConfig(lambda = 50.0, iterations = 50))
                )
            ),
            output = OutputFormatConfig(
                outputName = "test_output",
    ...
    @Test
    fun `processAstro runs with enhance using sigmoid with highlightProtection`() {
        initTestRun()
        createRandomAstroImages(testDir, "light", 10, addBiasNoise = false)
        ...
        val config = ProcessConfig(
            ...
            enhance = EnhanceConfig(
                steps = mutableListOf(
                    EnhanceStepConfig(
                        sigmoid = SigmoidConfig(midpoint = 0.3, strength = 1.1),
    ...
    @Test
    fun `processAstro runs with enhance using ghs with highlightProtection`() {
        initTestRun()
        createRandomAstroImages(testDir, "light", 10, addBiasNoise = false)
        ...
        val config = ProcessConfig(
            ...
            enhance = EnhanceConfig(
                steps = mutableListOf(
                    EnhanceStepConfig(
                        generalizedHyperbolicStretch = GHSConfig(D = 5.0, b = 5.0, SP = 0.1, LP = 0.0, HP = 1.0),
                        highlightProtection = HighlightProtectionConfig(threshold = 0.5)
                    )
                )
            ),
    ...
    @Test
    fun `processAstro runs with enhance using arcsinh with highlightProtection`() {
        initTestRun()
        createRandomAstroImages(testDir, "light", 10, addBiasNoise = false)
